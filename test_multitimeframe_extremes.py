...
# ============================================================
# EXPERIMENTO 37
# BRANCH 14 — MULTI-TIMEFRAME RECENT EXTREMES
#
# DEVELOPMENT:
# 2024-01 -> 2026-07
#
...
# Para cada candle t:
#
# previous_high_6h = máxima dos 72 candles anteriores
# previous_low_6h  = mínima dos 72 candles anteriores
#
# previous_high_24h = máxima dos 288 candles anteriores
# previous_low_24h  = mínima dos 288 candles anteriores
#
# Eventos:
#
# BREAK_HIGH_6H
...
for symbol in SYMBOLS:
    ...
    print(
        f"PROCESSANDO MULTI-TIMEFRAME EXTREMES — {symbol}"
    )
    ...
    for window_name, bars in WINDOWS.items():

        # ----------------------------------------------------
        # Past only.
        #
        # Current candle cannot define its own breakout level.
        # ----------------------------------------------------

        df[
            f"previous_high_{window_name}"
        ] = (
            df["high"]
            .shift(1)
            .rolling(
        ...
        masks = {
            ...
            f"BREAK_HIGH_{window_name}":
                break_high_event,

            f"BREAK_LOW_{window_name}":
                break_low_event,
        }
...
HYPOTHESES = {
    ...
    # 6H
    "HIGH_6H_CONTINUE_LONG":
        (
            "BREAK_HIGH_6H",
            "LONG",
        ),

    "HIGH_6H_REVERSE_SHORT":
        (
            "BREAK_HIGH_6H",
            "SHORT",
        ),

    "LOW_6H_CONTINUE_SHORT":
        (
            "BREAK_LOW_6H",
            "SHORT",
        ),
    ...
    # 24H
    "HIGH_24H_CONTINUE_LONG":
        (
            "BREAK_HIGH_24H",
            "LONG",
        ),

    "HIGH_24H_REVERSE_SHORT":
        (
            "BREAK_HIGH_24H",
            "SHORT",
        ),

    "LOW_24H_CONTINUE_SHORT":
        (
            "BREAK_LOW_24H",
            "SHORT",
        ),

    "LOW_24H_REVERSE_LONG":
        (
            "BREAK_LOW_24H",
            "LONG",
        ),
...
print(
    "EXPERIMENTO 37 — "
    "BRANCH 14 MULTI-TIMEFRAME EXTREMES"
)
...
counts.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_counts.csv",
    index=False,
)
...
anatomy.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_anatomy.csv",
    index=False,
)
...
global_results.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_global.csv",
    index=False,
)
...
by_year.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_by_year.csv",
    index=False,
)
...
by_asset.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_by_asset.csv",
    index=False,
)
...
monthly.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_monthly.csv",
    index=False,
)
...
stability.to_csv(
    RESULTS_DIR
    /
    "multitimeframe_extremes_stability.csv",
    index=False,
)
